...
#' Based on unet script: 
#' Falbel D, Żak K (2025). _unet: U-Net: Convolutional Networks for Biomedical Image
#' Segmentation_. R package version 0.1, <https://github.com/r-tensorflow/unet>.
